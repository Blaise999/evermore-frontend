...
export default function VerifyEmailErrorClient() {
  ...
  const reason = String(sp.get("reason") || "This verification link is invalid or has expired.");
  ...
  return (
    <div className="mx-auto w-full max-w-xl">
      <div className="rounded-[32px] bg-white p-7 ring-1 ring-slate-200 shadow-[0_26px_90px_rgba(2,8,23,.10)] sm:p-9">
        ...
        <h1 className="mt-4 text-2xl font-semibold tracking-tight text-slate-900">Link expired or invalid</h1>
